...
public class GetCompletedCourseStudentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        map.put("completedCourseStudent", gson.toJson(administratorService.getCompletedCourseStudent(cName)));
